...
Window::Window(WindowData w_dat) {
	...
	RenderingTool::Initialize(this->ren);
}
...
EventType Window::PollEvent() {
	...
	case SDL_MOUSEBUTTONDOWN:
		this->evt.motion.y *= -1;
		this->evt.motion.x -= Constant::ORIGIN_X;
		this->evt.motion.y += Constant::ORIGIN_Y;
		switch(this->evt.button.button) {
		case SDL_BUTTON_LEFT:
			this->scene_list.front()->PushEvent(MOUSE_DOWN, this->evt.button.x, this->evt.button.y, 0, 0, MOUSE_LEFT);
			break;
		case SDL_BUTTON_RIGHT:
			this->scene_list.front()->PushEvent(MOUSE_DOWN, this->evt.button.x, this->evt.button.y, 0, 0, MOUSE_RIGHT);
			break;
		case SDL_BUTTON_MIDDLE:
			this->scene_list.front()->PushEvent(MOUSE_DOWN, this->evt.button.x, this->evt.button.y, 0, 0, MOUSE_MIDDLE);
			break;
		}
		return MOUSE_DOWN;
	case SDL_MOUSEBUTTONUP:
		...
		switch (this->evt.button.button) {
			case SDL_BUTTON_LEFT:
				this->scene_list.front()->PushEvent(MOUSE_UP, this->evt.button.x, this->evt.button.y, 0, 0, MOUSE_LEFT);
				break;
			case SDL_BUTTON_RIGHT:
				this->scene_list.front()->PushEvent(MOUSE_UP, this->evt.button.x, this->evt.button.y, 0, 0, MOUSE_RIGHT);
				break;
			case SDL_BUTTON_MIDDLE:
				this->scene_list.front()->PushEvent(MOUSE_UP, this->evt.button.x, this->evt.button.y, 0, 0, MOUSE_MIDDLE);
				break;
		}
		return MOUSE_UP;
	case SDL_MOUSEMOTION:
		...
		this->evt.motion.x -= Constant::ORIGIN_X;
		this->evt.motion.y += Constant::ORIGIN_Y;
		this->scene_list.front()->PushEvent(MOUSE_MOVE, this->evt.motion.x, this->evt.motion.y, this->evt.motion.xrel, this->evt.motion.yrel, MOUSE_NONE);
		return MOUSE_MOVE;
	default:
		return NONE;
	}
